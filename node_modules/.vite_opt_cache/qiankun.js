...
function setWindowProp(prop, value, toDelete) {
  if (value === undefined && toDelete) {
    delete window[prop];
  } else if (isPropConfigurable(window, prop) && _typeof$1(prop) !== 'symbol') {
...
function loadApp(app) {
  ...
  return __awaiter(this, void 0, void 0, /*#__PURE__*/regenerator.mark(function _callee16() {
    var _this = this;
...
function loadMicroApp(app, configuration, lifeCycles) {
  ...
  return C(memorizedLoadingFn, Object.assign({
...
function start() {
  ...
  if (sandbox) {
    if (!window.Proxy) {
      ...
      frameworkConfiguration.sandbox = _typeof$1(sandbox) === 'object' ? Object.assign(Object.assign({}, sandbox), {
        loose: true
      }) : {
        loose: true
      };
...
export { SandBoxType, a as addErrorHandler, addGlobalUncaughtErrorHandler, initGlobalState, loadMicroApp, prefetchImmediately as prefetchApps, registerMicroApps, c as removeErrorHandler, removeGlobalUncaughtErrorHandler, runAfterFirstMounted, runDefaultMountEffects, setDefaultMountApp, start };
